package net.lizistired.animationoverhaul.pestomodels;
...
public class ModelOutputImpl {
    ...
    public static void outputPartDefinition(String string, ModelTransform partPose, ModelPartBuilder cubeListBuilder, ModelTransform partPose2){
        /*

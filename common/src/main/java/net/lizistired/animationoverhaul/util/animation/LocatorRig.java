...
public class LocatorRig {
    ...
    public void addLocatorModelPart(Locator locator, Locator locatorMirrored, String modelPartIdentifier, ModelTransform defaultPose){
        locatorEntryHashMap.putIfAbsent(locator, new LocatorEntry(locator, locatorMirrored, modelPartIdentifier, defaultPose));
    }

    public void addLocatorModelPart(Locator locator, String modelPartIdentifier, ModelTransform defaultPose){
    ...
    public void addLocatorModelPart(Locator locator, Locator locatorMirrored, String modelPartIdentifier){
        addLocatorModelPart(locator, locatorMirrored, modelPartIdentifier, ModelTransform.NONE);
    }

    public void addLocatorModelPart(Locator locator, String modelPartIdentifier){
        addLocatorModelPart(locator, modelPartIdentifier, ModelTransform.NONE);
    }

    public void addLocator(Locator locator, Locator locatorMirrored){
        locatorEntryHashMap.putIfAbsent(locator, new LocatorEntry(locator, locatorMirrored, null, ModelTransform.NONE));
    }
    ...
    public HashMap<LocatorRig.LocatorEntry, ModelTransform> bakePose(){
        HashMap<LocatorRig.LocatorEntry, ModelTransform> hashMap = Maps.newHashMap();
        for(Locator locator : locatorEntryHashMap.keySet()){
    ...
    public static class LocatorEntry {
        ...
        public final ModelTransform defaultPose;

        public LocatorEntry(Locator locator, Locator locatorMirrored, @Nullable String modelPartIdentifier, ModelTransform defaultPose){
